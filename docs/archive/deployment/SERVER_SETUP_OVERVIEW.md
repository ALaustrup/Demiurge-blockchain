...
- **Missing:** QorIDDialog integration
...
4. **QOR Gateway** (manual, not in PM2 yet)
   - Port 4000 (GraphQL)
...
2. ✅ **Complete Phase 5 Frontend** - Connect QorID backend
3. ⚠️ **Upload Media Files** - Add video backgrounds
4. ⏳ **Add Chain Node to PM2** - Automate blockchain node
5. ⏳ **Add QOR Gateway to PM2** - Automate GraphQL service
