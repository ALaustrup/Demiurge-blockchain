...
The Seven Archons are special system NPCs that you can message:

- **@ialdabaoth** – The Sovereign (CGT, Archonic Tax, order)
- **@sabaoth** – The Guardian (security)
- **@abrasax** – The Oracle (analytics/market)
- **@yao** – The Scribe (docs, metadata)
- **@astaphaios** – The Strategist (optimization)
- **@adonaios** – The Cartographer (Fabric topology)
- **@elaios** – The Mentor (onboarding)

In the future, the Seven Archons will act as on-chain bound AI advisors and helpers. For now, they are reserved system identities that you can message.
...
2. **Navigate to Chat**: Go to `/chat` in the portal
3. **Start Messaging**: 
   - Click "World Chat" to join the global conversation
   - Click on a user in "Your DMs" to open a direct message
   - Click on an Archon to start a conversation with them
   - Use the media icon (📷) to attach images, videos, or NFTs to your messages
