...
export function AbyssWriterApp() {
  ...
  return (
    <div className="h-full w-full flex flex-col bg-abyss-dark/90 text-gray-100">
      <div className="px-6 py-4 border-b border-abyss-cyan/20 flex items-center justify-between">
        <div>
          <div className="text-2xl font-bold text-abyss-cyan">Abyss Writer</div>
          <div className="text-sm text-gray-400">Rich text, autosave, export (docx/pdf/md coming soon)</div>
        </div>
      ...
      <div className="p-4 flex flex-col gap-3">
        <input
          className="px-3 py-2 bg-abyss-dark border border-abyss-cyan/30 rounded text-lg font-semibold"
          value={title}
        ...
        <div className="flex gap-2 text-xs text-gray-400">
          ...
          <span>• AbyssID-linked sync coming soon</span>
        </div>
        <textarea
          className="flex-1 min-h-[420px] px-3 py-3 bg-abyss-dark border border-abyss-cyan/30 rounded text-sm leading-relaxed"
          value={content}
