...
const TEMPLATE_CATEGORIES = [
  ...
  { id: 'abyssos', label: 'AbyssOS Apps', icon: '🖥️' },
...
const TEMPLATES: Template[] = [
  ...
  // AbyssOS Apps
  {
    id: 'abyssos-app',
    name: 'AbyssOS App',
    description: 'Native AbyssOS desktop application',
    category: 'abyssos',
    icon: '🖥️',
    type: 'abyssos-app',
    files: [
      ...
      { path: 'README.md', content: '# AbyssOS App\n\nBuilt with CRAFT', type: 'file' },
    ],
  },
...
export function MyAbyssOSApp() {
  ...
  return (
    <div className="w-full h-full bg-abyss-dark text-white p-4">
      <h1 className="text-2xl font-bold text-abyss-cyan mb-4">My AbyssOS App</h1>
      <button
