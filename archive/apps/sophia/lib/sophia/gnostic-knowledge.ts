...
export const GNOSTIC_KNOWLEDGE: GnosticEntry[] = [
  ...
  },
  {
    ...
    protocolMapping:
      'The Monad is the genesis -- the origin point of the chain. The genesis block is the Monad from which all subsequent blocks, transactions, and state emanate. The local Studio node on this machine (Pleroma) is that origin for development; there is no remote VPS bootnode.',
