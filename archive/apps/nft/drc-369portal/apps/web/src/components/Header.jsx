  ...
  return (
    <div className="h-16 bg-[#F3F3F3] dark:bg-[#1A1A1A] flex items-center justify-between px-4 md:px-6 flex-shrink-0 border-b border-[#E5E5E5] dark:border-[#333333]">
      ...
      <div className="flex items-center space-x-2 md:space-x-4">
        ...
        <button className="h-10 px-4 md:px-6 rounded-full bg-gradient-to-br from-purple-500 to-blue-600 text-white font-semibold text-sm transition-all duration-150 hover:shadow-lg hover:scale-105 active:scale-95 font-inter flex items-center gap-2">
          <Wallet size={16} />
